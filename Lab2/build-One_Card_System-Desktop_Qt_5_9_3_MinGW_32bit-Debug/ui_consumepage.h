...
public:
    ...
    QLabel *label_2;
    QLabel *label;
    QComboBox *comboBox_foodName;
    QLabel *label_3;
    QLineEdit *lineEdit_ReadId;
    ...
    void setupUi(QWidget *ConsumePage)
    {
        ...
        gridLayout->addWidget(btn_Enventory, 6, 3, 1, 1);
        ...
        gridLayout->addWidget(lineEdit_tagId, 5, 1, 1, 3);
        ...
        gridLayout->addWidget(lineEdit_time1, 4, 1, 1, 3);
        ...
        gridLayout->addWidget(lineEdit_value, 1, 1, 1, 3);
        ...
        comboBox_foodName = new QComboBox(groupBox_2);
        comboBox_foodName->setObjectName(QStringLiteral("comboBox_foodName"));
        comboBox_foodName->setFont(font);

        gridLayout->addWidget(comboBox_foodName, 0, 2, 1, 2);
        ...
        lineEdit_ReadId = new QLineEdit(groupBox_2);
        lineEdit_ReadId->setObjectName(QStringLiteral("lineEdit_ReadId"));
        lineEdit_ReadId->setFont(font);

        gridLayout->addWidget(lineEdit_ReadId, 2, 1, 1, 3);
        ...
        lineEdit_addr1 = new QLineEdit(groupBox_3);
        lineEdit_addr1->setObjectName(QStringLiteral("lineEdit_addr1"));
        lineEdit_addr1->setFont(font);

        gridLayout_2->addWidget(lineEdit_addr1, 3, 1, 1, 3);
        ...
        gridLayout_2->addWidget(lineEdit_time2, 4, 1, 1, 3);
        ...
        gridLayout_2->addWidget(lineEdit_tagId1, 5, 1, 1, 3);
        ...
        gridLayout_2->addWidget(btn_Enventory1, 6, 3, 1, 1);
        ...
        gridLayout_4->addWidget(lineEdit_tagId2, 5, 1, 1, 3);
        ...
        gridLayout_4->addWidget(btn_Enventory2, 6, 3, 1, 1);
        ...
        gridLayout_4->addWidget(lineEdit_time3, 4, 1, 1, 3);
        ...
        lineEdit_addr2 = new QLineEdit(groupBox_4);
        lineEdit_addr2->setObjectName(QStringLiteral("lineEdit_addr2"));
        lineEdit_addr2->setFont(font);

        gridLayout_4->addWidget(lineEdit_addr2, 3, 1, 1, 3);
        ...
        lineEdit_addr3 = new QLineEdit(groupBox_5);
        lineEdit_addr3->setObjectName(QStringLiteral("lineEdit_addr3"));
        lineEdit_addr3->setFont(font);

        gridLayout_5->addWidget(lineEdit_addr3, 3, 1, 1, 3);
        ...
        gridLayout_5->addWidget(lineEdit_time4, 4, 1, 1, 3);
        ...
        gridLayout_5->addWidget(lineEdit_tagId3, 5, 1, 1, 3);

        horizontalSpacer_4 = new QSpacerItem(40, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);

        gridLayout_5->addItem(horizontalSpacer_4, 6, 2, 1, 1);
        ...
        gridLayout_5->addWidget(btn_Enventory3, 6, 3, 1, 1);
    ...
    void retranslateUi(QWidget *ConsumePage)
    {
        ...
        groupBox->setTitle(QApplication::translate("ConsumePage", "\346\266\210\350\264\271\346\250\241\346\213\237", Q_NULLPTR));
        label_Tips->setText(QString());
        groupBox_2->setTitle(QApplication::translate("ConsumePage", "\351\243\237\345\240\202", Q_NULLPTR));
        btn_Enventory->setText(QApplication::translate("ConsumePage", "\350\257\206\345\210\253", Q_NULLPTR));
        lineEdit_tagId->setText(QString());
        label_4->setText(QApplication::translate("ConsumePage", "\345\234\260\347\202\271\357\274\232", Q_NULLPTR));
        ...
        label_2->setText(QApplication::translate("ConsumePage", "\351\207\221\351\242\235\357\274\232", Q_NULLPTR));
        label->setText(QApplication::translate("ConsumePage", "\345\225\206\345\223\201\347\261\273\345\210\253\357\274\232", Q_NULLPTR));
        label_3->setText(QApplication::translate("ConsumePage", "\347\274\226\345\217\267\357\274\232", Q_NULLPTR));
        ...
        btn_OK->setText(QApplication::translate("ConsumePage", "\347\273\223\350\264\246", Q_NULLPTR));
        groupBox_3->setTitle(QApplication::translate("ConsumePage", "\346\225\231\345\255\246\346\245\274", Q_NULLPTR));
        ...
        label_11->setText(QApplication::translate("ConsumePage", "\345\234\260\347\202\271\357\274\232", Q_NULLPTR));
        ...
        label_18->setText(QApplication::translate("ConsumePage", "\345\234\260\347\202\271\357\274\232", Q_NULLPTR));
        ...
        groupBox_5->setTitle(QApplication::translate("ConsumePage", "\345\205\266\344\273\226", Q_NULLPTR));
        ...
        label_25->setText(QApplication::translate("ConsumePage", "\345\234\260\347\202\271\357\274\232", Q_NULLPTR));
